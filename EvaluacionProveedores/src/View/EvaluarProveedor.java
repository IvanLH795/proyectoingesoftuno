...
public class EvaluarProveedor extends javax.swing.JFrame {
    ...
    private void ingresarEvaluacionButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ingresarEvaluacionButtonActionPerformed
      ...
      Proveedores proveedor2 = new Proveedores();
        ...
        proveedor2.setCalidad(calidadProductosTextField.getText());
        proveedor2.setFiabilidad(fiabilidadEntregaTextField.getText());
        proveedor2.setAdaptabilidad(adaptabilidadSeleccion.getToolTipText());
        proveedor2.setCercania(cercaniaGeograficaSeleccion.getToolTipText());
        proveedor2.setComentarios(comentariosTextField.getText());
        nuevo.ingresarEvaluacionProveedor(proveedor, proveedor2);
